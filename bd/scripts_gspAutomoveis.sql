...
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Luiz', 22726014571, 13410553435, 'Luiz@gmail.com', '2005-07-08', 'Luiz047', 'Luizz123', 'Administrador', 500.000, 2.5, true, 1);
...
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Eric', 17541062722, 53964108953, 'Eric@gmail.com' , '2005-10-06', 'Eric047', 'Ericc123', 'Administrador', 500.000, 2.5, true, 3);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Sabel', 06352419784, 7327146365, 'Sabel@gmail.com', '2005-12-31', 'Sabel047', 'Sabell123', 'Administrador', 500.000, 2.5, true, 4);
