...
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Luiz', 22726014571, 47991877294, 'luiz.s08@aluno.ifsc.edu.br', '2005-07-08', 'Luiz047', 'Luizz123', 'Administrador', 500.000, 2.5, true, 1);
