...
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Luiz', 22726014571, 47991877294, 'luiz.s08@aluno.ifsc.edu.br', '2005-07-08', 'Luiz047', 'Luizz123', 'Administrador', 500.000, 2.5, false, 1);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Gabriel', 48791425360, 35980146935, 'Biell7@gmail.com', '2004-07-17', 'Biell047', 'Biell777', 'Administrador', 500.000, 2.5, true, 2);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Eric', 17541062722, 47992609257, 'eric.o26@aluno.ifsc.edu.br' , '2005-10-06', 'Eric047', 'Ericc123', 'Administrador', 500.000, 2.5, true, 3);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Sabel', 06352419784, 47997518703, 'luis.g2005@aluno.ifsc.edu.br', '2005-12-31', 'Sabel047', 'Sabell123', 'Administrador', 500.000, 2.5, true, 4);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('João', 53435501431, 4006755218, 'João@gmail.com', '2005-12-08', 'João047', 'joaoo123', 'Administrador', 500.000, 2.5, true, 5);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Puopi', 01907683046, 4926166947, 'Puopi@gmail.com', '2002-05-04', 'Puopi047', 'Puopii123', 'Vendedor', 70.000, 0.5, true, 9);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Batay', 67459166065, 8433195843, 'Batay@gmail.com', '1999-12-28', 'Batay047', 'Batayy123', 'Gerente de Estoque', 50.000, 0.3, true, 10);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Lohad', 43206516005, 8132386314, 'Lohad@gmail.com', '2003-11-10', 'Lohad047', 'Lohadd123', 'Gerente de Estoque', 50.000, 0.3, true, 11);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Faerion', 58749084046, 1833291657, 'Faerion@gmail.com', '1998-01-02', 'Faerion047', 'Faerionn123', 'Gerente de Vendas', 70.000, 1.0, true, 12);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Geagorod', 06723877004, 6332618715, 'Geagorod@gmail.com', '2000-03-25', 'Geagorod047', 'Geagorod123', 'Vendedor', 70.000, 0.5, true, 13);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Fowyaze', 82863483030, 6738832922, 'Fowyaze@gmail.com', '1996-08-09', 'Fowyaze047', 'Fowyazee123', 'Vendedor', 70.000, 0.5, true, 14);
insert into funcionarios (nome, cpf, telefone, email, dataDeNasc, usuario, senha, NivelCargo, salario, comissao, validado, enderecos_id_endereco) values ('Riek', 87327642005, 6323543033, 'Riek@gmail.com', '2002-10-15', 'Riek047', 'Riekk123', 'Gerente de Vendas', 100.000, 1.0, true, 15);
